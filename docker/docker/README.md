...
1.在文件编辑器上，使用全局替换的方式，将文件夹下的所有 `101.43.189.185`替换为服务器的ip
...
请自行101.43.189.185替换为服务器ip

 - mysql: 使用数据库连接工具进行连接， 端口3306 账号及密码 root/root
 - minio: http://101.43.189.185:9000 账号及密码 admin/admin123456
 - redis: 端口6379，没有密码
 - nacos: http://101.43.189.185:8848/nacos 账号及密码 nacos/nacos
 - kibana: http://101.43.189.185:5601
 - rocketmq-console：http://101.43.189.185:8180
...
http://101.43.189.185:5601/app/dev_tools#/console
